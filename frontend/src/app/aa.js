...
export default function LihatPesan() {
  ...
  return (
    <>
      <ToastContainer />
      <div className="flex flex-col md:flex-row h-full w-full gap-4 md:gap-6 p-2 md:p-6">
        {/* Sidebar daftar pesan */}
        <aside className="md:w-1/3 w-full bg-white rounded-2xl shadow-md border p-0 md:p-2 overflow-hidden flex flex-col max-h-[80vh]">
          <div className="px-4 py-3 border-b bg-gray-50 flex items-center justify-between">
            <span className="font-bold text-lg text-purple-800 flex items-center gap-2">
              Pesan Masuk
              <span className="inline-flex items-center justify-center bg-purple-600 text-white text-xs font-semibold rounded-full h-6 min-w-[1.5rem] px-2 ml-1">
            ...
            {loading ? (
              ...
              <ul>
                {pesanList.map((pesan) => (
                  ...
                  >
                    {/* Badge bulat inisial */}
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-purple-200 flex items-center justify-center font-bold text-purple-700 text-lg uppercase">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        ...
                        {!pesan.sudah_dibaca && (
                          <span className="ml-2 inline-block w-2 h-2 rounded-full bg-purple-600" title="Belum dibaca"></span>
                        )}
                      </div>
        ...
        {/* Detail pesan */}
        <section className="flex-1 w-full bg-white rounded-2xl shadow-md border p-4 md:p-8 flex flex-col max-h-52">
          {!selectedPesan ? (
            ...
            <>
              <div className="flex flex-col md:flex-row md:items-center gap-4 border-b pb-4 mb-4">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-full bg-purple-200 flex items-center justify-center font-bold text-purple-700 text-2xl uppercase">
