export default function ListLowonganPageTampilanSaja() {
  // Dummy data for tampilan only
  const filteredLowongan = [
    {
      _id: "1",
      nama_lowongan: "Frontend Developer",
      nama_perusahaan: "PT. Maju Mundur",
      lokasi: "Jakarta",
      tipe_kerja: "Full Time",
      deskripsi: "Bertanggung jawab untuk membangun antarmuka pengguna aplikasi web modern menggunakan ReactJS dan teknologi terbaru.",
      gaji: "Rp 8.000.000 - 12.000.000",
      status: "open",
      jumlah_pelamar: 12,
      batas_pelamar: 30,
      traffic: 120,
      batas_lamaran: "2024-07-31",
      createdAt: "2024-06-01T10:00:00Z",
      logo_perusahaan: "",
    },
    {
      _id: "2",
      nama_lowongan: "Backend Engineer",
      nama_perusahaan: "CV. Sukses Selalu",
      lokasi: "Bandung",
      tipe_kerja: "Remote",
      deskripsi: "Membangun dan memelihara API backend menggunakan Node.js dan Express. Pengalaman dengan MongoDB diutamakan.",
      gaji: "Rp 10.000.000 - 15.000.000",
      status: "closed",
      jumlah_pelamar: 25,
      batas_pelamar: 25,
      traffic: 200,
      batas_lamaran: "2024-06-15",
  ...
  function truncateDescription(desc, maxWords = 30) {
                ...
                >
                  ...
                  <div className="w-16 h-16 rounded-xl bg-[#eaf7e6] flex items-center justify-center mr-6 flex-shrink-0 overflow-hidden border border-[#e0e0e0]">
                    {item.logo_perusahaan ? (
                      <img
                        src={item.logo_perusahaan.startsWith("http")
                          ? item.logo_perusahaan
                  ...
                  <div className="flex-1 flex flex-col justify-between min-w-0">
                    ...
                    <div className="mt-2 mb-1">
                      <span className="text-[15px] text-[#444] font-normal block">
                    ...
                    <div className="flex flex-wrap items-center gap-x-6 gap-y-1 mt-2">
                      ...
                      <span className="flex items-center text-[14px] text-[#6c757d] font-normal">
                        <svg className="mr-1" width="15" height="15" fill="none" viewBox="0 0 20 20">
                          <path d="M2 10a8 8 0 1 1 16 0A8 8 0 0 1 2 10zm8-6a6 6 0 1 0 0 12A6 6 0 0 0 10 4zm0 2a1 1 0 0 1 1 1v3h2a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1z" fill="#6c757d"/>
                        </svg>
