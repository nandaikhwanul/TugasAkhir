    ...
    <div className="min-h-screen bg-gray-100 py-6 px-0 w-full max-w-full">
      <div className="w-full max-w-full mx-0 space-y-8 px-0">
        ...
        <div className="p-4 sm:p-6 md:p-8 lg:p-10 w-full max-w-full">
          ...
          {loadingRekom ? (
            <div className="text-gray-400 text-sm px-2 py-6">Memuat rekomendasi lowongan...</div>
          ) : errorRekom ? (
            <div className="text-red-500 text-sm px-2 py-6">{errorRekom}</div>
          ) : rekomendasiLowongan.length === 0 ? (
            <div className="text-gray-500 text-sm px-2 py-6">Belum ada rekomendasi lowongan untukmu saat ini.</div>
          ) : (
