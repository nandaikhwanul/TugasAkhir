  ...
  useEffect(() => {
    ...
    const fetchLowongan = async () => {
      ...
      try {
        ...
        const res = await axios.get("http://localhost:5000/lowongan", {
          headers: token
                    ...
                    <img
                      src={
                        (() => {
                          ...
                          if (logo.startsWith("/uploads/")) return `http://localhost:5000${logo}`;
                          return `http://localhost:5000/uploads/perusahaan/${logo}`;
                        })()
                      }
                      alt="Logo Perusahaan"
