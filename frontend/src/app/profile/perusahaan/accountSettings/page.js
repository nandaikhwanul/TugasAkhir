...
export default function PerusahaanAccountSettings() {
  ...
  async function handleSaveEmailPerusahaan(e) {
    ...
    try {
      const patchRes = await fetch(`https://tugasakhir-production-6c6c.up.railway.app/perusahaan/${perusahaanId}`, {
        method: "PATCH",
        headers: {
  ...
  async function handleSavePassword(e) {
    ...
    try {
      const checkRes = await fetch("https://tugasakhir-production-6c6c.up.railway.app/perusahaan/me/checkoldpassword", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
