...
export default function FotoPerusahaanPage() {
  ...
  useEffect(() => {
    const fetchPerusahaanAndFotos = async () => {
      ...
      try {
        ...
        const resPerusahaan = await fetch("http://localhost:5000/perusahaan/me", {
          headers: {
        ...
        if (
          ...
          const res = await fetch(
            `http://localhost:5000/foto-perusahaan/perusahaan/${id}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      const res = await fetch("http://localhost:5000/foto-perusahaan/upload", {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleDeleteFoto = async (foto) => {
    ...
    try {
      ...
      const res = await fetch("http://localhost:5000/foto-perusahaan/delete", {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
